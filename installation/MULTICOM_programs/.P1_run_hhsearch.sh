...
perl SOFTWARE_PATH/src/meta/hhsearch/script/tm_hhsearch_main_v2.pl SOFTWARE_PATH/src/meta/hhsearch/hhsearch_option_cluster $fastafile $outputdir  2>&1 | tee   $outputdir/run_hhsearch.log
