...
#	if ($hour == 1 && $days[$day] == 0) #read hour 1, and is not updated today yet
	{
		...
		`date >> update.log`;
		system("/home/jh7x3/multicom_v1.1/src/update_db/tools/ffas/build_db_update.pl");
		`date >> update.log`;
...
#			print "finish updateing sparks database.\n";	
			...
			`date >> update.log`; 
			system("/home/jh7x3/multicom_v1.1/src/update_db/tools/hhsuite/gen_db.sh > hhsuite.log");
			`date >> update.log`;
