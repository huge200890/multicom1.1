...
system("$multicom_dir/script/refine_model_tails.pl /home/jh7x3/multicom_v1.1/src/meta/run_rosetta_refine.sh $full_length_dir/meta/$model_prefix.pir $full_length_dir/meta/$model_prefix.pdb  $refine_dir $refine_num 2>&1 1>/dev/null");  
