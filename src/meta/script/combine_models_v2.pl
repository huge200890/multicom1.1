...
$pdb2casp1 = "/home/jh7x3/multicom_v1.1/src/prosys/script/pdb2casp.pl";
...
for ($i = 0; $i < @new_rank && $i < 5; $i++)
{
	...
	if (-f $model_file && -f $pir_file)
	{
		...
		system("/home/jh7x3/multicom_v1.1/tools/scwrl4/Scwrl4 -i $model_file -o $model_name.scw >/dev/null");
	    #system("/home/casp13/MULTICOM_package/casp8/model_cluster/script/clash_check.pl $fasta_file $model_name.scw > con_clash$i.txt");
	    system("/home/jh7x3/multicom_v1.1/src/meta/model_cluster/script/clash_check.pl $fasta_file $model_name.scw > con_clash$i.txt");
