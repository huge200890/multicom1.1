...
while ($count <= 5)
{
	...
	system("/home/jh7x3/multicom_v1.1/src/meta/model_cluster/script/stx_model_comb_global.pl /home/jh7x3/multicom_v1.1/tools/tm_score/TMscore_32 $casp_model_dir $name.score $fasta_file $output_dir/$name.pir 2.5 0.8 0.5");
	...
	while (@pir < 10)
	{
		...
		system("/home/jh7x3/multicom_v1.1/src/meta/model_cluster/script/stx_model_comb.pl /home/jh7x3/multicom_v1.1/tools/tm_score/TMscore_32 $casp_model_dir $name.score $fasta_file $output_dir/$name.pir 2.5 $length $gdt");
	...
	system("/home/jh7x3/multicom_v1.1/src/prosys/script/pir2ts_energy.pl /home/jh7x3/multicom_v1.1/tools/modeller-9.16/ $casp_model_dir $output_dir $output_dir/$name.pir 3");
