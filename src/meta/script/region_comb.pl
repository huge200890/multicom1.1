...
#############################domain combination########################################
$cm_model_num = 5; 
$modeller_dir = "/home/jh7x3/multicom_v1.1/tools/modeller9v7/"; 
$prosys_dir = "/home/jh7x3/multicom_v1.1/src/prosys/";
$final_model_num = 5; 
...
for ($m = 0; $m < @servers; $m++)
{
	...
	for ($i = 0; $i < $final_model_num; $i++)
	{
		...
		if ( -f "$comb_dir/$server$idx.pdb")
		{
			...
			system("/home/jh7x3/multicom_v1.1/tools/scwrl4/Scwrl4 -i $comb_dir/$server$idx.pdb -o $comb_dir/$server$idx.pdb.scw >/dev/null");
			system("/home/jh7x3/multicom_v1.1/src/meta/model_cluster/script/clash_check.pl $fasta_file $comb_dir/$server$idx.pdb.scw > $comb_dir/$server-clash$idx.txt");
