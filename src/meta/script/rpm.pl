...
chdir $model_dir; 
$cluster_dir = "/home/jh7x3/multicom_v1.1/src/meta/model_cluster/script";
$iteration = 1; 
...
while (1)
{
	...
	system("$cluster_dir/consensus_qa.robust.casp9.pl $cluster_dir /home/jh7x3/multicom_v1.1/tools/spicker/spicker . $prev_global_quality_file $query_name $query_name.local.$iteration");
	...
	$refine_dir = ".";
	$refine_num = 100; 
	$multicom_dir = "/home/jh7x3/multicom_v1.1/src/meta/script"; 
	system("$multicom_dir/script/refine_model_range.pl /home/jh7x3/multicom_v1.1/src/meta/cheng_group/bin/run_rosetta_refine.sh casp1.pdb  $refine_dir $refine_num 2>&1 1>/dev/null");
	...
	$tm_score = "/home/jh7x3/multicom_v1.1/tools/tm_score/TMscore_32";
	$q_score =  "/home/jh7x3/multicom_v1.1/tools/pairwiseQA/q_score";
