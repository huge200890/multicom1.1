...
$self = "/home/jh7x3/multicom_v1.1/src/meta/script/self.pl";
	...
	foreach $prefix (@prefixes)
	{
		...
		for ($i = 1; $i <= 5; $i++)
		{
			...
			if ($is_abinitio == 1)
			{
				...
				system("/home/jh7x3/multicom_v1.1/tools/scwrl4/Scwrl4 -i $casp_model.self.pdb -o $casp_model.self.scw  >/dev/null");
