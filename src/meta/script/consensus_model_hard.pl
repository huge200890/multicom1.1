...
$tm_score_program = "/home/jh7x3/multicom_v1.1/tools/tm_score/TMscore_32";
...
$model_dir = "$target_dir/full_length_hard/meta";
...
for ($i = 1; $i <= 5; $i++)
{
	...
	if (-f $model_file)
	{
		...
		system("/home/jh7x3/multicom_v1.1/tools/scwrl4/Scwrl4 -i $model_file -o $consensus_dir/$model_name-$i.pdb.scw >/dev/null");
		...
		system("/home/jh7x3/multicom_v1.1/src/meta/model_cluster/script/clash_check.pl $model_dir/$target_name.FASTA $consensus_dir/$model_name-$i.pdb.scw > $consensus_dir/clash$i.txt");
