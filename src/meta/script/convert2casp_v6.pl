...
while ($i <= $count && @eva)
{
	...
	system("/home/jh7x3/multicom_v1.1/tools/scwrl4/Scwrl4 -i $model_file -o $out_dir/$model_name.pdb.scw >/dev/null");
	system("/home/jh7x3/multicom_v1.1/src/meta/model_cluster/script/clash_check.pl $fasta_file $out_dir/$model_name.pdb.scw > $out_dir/a_clash$i.txt");
...
system("/home/jh7x3/multicom_v1.1/src/meta/script/iqa_v2.pl $out_dir/meta.eva $mdir $fasta_file $out_dir/$target_name.iqa"); 
...
while ($i <= $count && @eva)
{
	...
	#repack the side chains 
	system("/home/jh7x3/multicom_v1.1/tools/scwrl4/Scwrl4 -i $model_file -o $out_dir/$model_name.pdb.scw >/dev/null");
	system("/home/jh7x3/multicom_v1.1/src/meta/model_cluster/script/clash_check.pl $fasta_file $out_dir/$model_name.pdb.scw > $out_dir/b_clash$i.txt");
	#if ($method eq "cm" || $method eq "fr")
	if (-f $pir_file)
	{
...
$max_file = "$full_length_dir/meta/$target_name.max";
$a_rank = 1000; 
$b_rank = 1000; 
...
for ($i = 1; $i <= $count; $i++)
{
	...
	if (-f $model_file)
	{
		system("/home/jh7x3/multicom_v1.1/tools/scwrl4/Scwrl4 -i $model_file -o $model_file.scw >/dev/null");
		system("/home/jh7x3/multicom_v1.1/src/meta/model_cluster/script/clash_check.pl $fasta_file $model_file.scw > $mdir/clash$i.txt");
...
for ($i = 1; $i <= $count; $i++)
{
	...
	if (-f "$model_file.org")
	{
		system("/home/jh7x3/multicom_v1.1/tools/scwrl4/Scwrl4 -i $model_file.org -o $mdir/casp$i.scw >/dev/null");
		system("/home/jh7x3/multicom_v1.1/src/meta/model_cluster/script/clash_check.pl $fasta_file $mdir/casp$i.scw > $mdir/clash$i.txt");
...
#		$model_file = "$mdir/$model_file";
		...
		if (-f $pir_file && -f $model_file)
		{
			...
			#do a self modeling
			system("/home/jh7x3/multicom_v1.1/src/meta/casp_tools/self.pl $model_file $model_file.self"); 

			system("/home/jh7x3/multicom_v1.1/tools/scwrl4/Scwrl4 -i $model_file.self.pdb -o $model_file.scw >/dev/null");
			system("/home/jh7x3/multicom_v1.1/src/meta/model_cluster/script/clash_check.pl $org_fasta_file $model_file.scw > $mdir/clash$i.txt");
...
while (@layer1_model && $i <= 5)
{
	...
	#repack the side chains 
	system("/home/jh7x3/multicom_v1.1/tools/scwrl4/Scwrl4 -i $model_file -o $model_file.scw >/dev/null");
	system("/home/jh7x3/multicom_v1.1/src/meta/model_cluster/script/clash_check.pl $fasta_file $model_file.scw > $out_dir/con_clash$i.txt");
