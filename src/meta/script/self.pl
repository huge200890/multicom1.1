...
$seq = `/home/jh7x3/multicom_v1.1/tools/model_eva1.0/script/pdb2seq.pl $in_pdb`;
...
system("/home/jh7x3/multicom_v1.1/src/prosys/script/pir2ts_energy.pl /home/jh7x3/multicom_v1.1/tools/modeller-9.16 $cur_dir/atomtmp $cur_dir/outtmp selftmp.pir 8");
