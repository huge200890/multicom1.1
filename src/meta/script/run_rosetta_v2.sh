...
export LD_LIBRARY_PATH=/home/jh7x3/multicom_v1.1/tools/rosetta3.1/rosetta_source/build/src/release/linux/2.6/64/x86/gcc/:$LD_LIBRARY_PATH
ROSETTA_PATH='/home/jh7x3/multicom_v1.1/tools/rosetta3.1'
...
$ROSETTA_PATH/rosetta_source/bin/AbinitioRelax.linuxgccrelease -in:file:fasta $fasta\
 -database $ROSETTA_PATH/rosetta_database/ -in:file:frag9 aa"$id"09_05.200_v1_3\
 -in:file:frag3 aa"$id"03_05.200_v1_3 -out:pdb -out:nstruct $NUM_OF_STRUCTURES
