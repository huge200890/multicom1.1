...
system("$meta_dir/script/filter_rank_file.pl /home/jh7x3/multicom_v1.1/databases/hhpred_dbs/database/pdb.list $work_dir/$name.rank $work_dir/$name.rank.fil");
...
system("$meta_dir/script/filter_alignments.pl /home/jh7x3/multicom_v1.1/databases/hhpred_dbs/database/pdb.list $fasta_file.local $fasta_file.local.fil");
...
system("$meta_dir/script/filter_rank_file.pl /home/jh7x3/multicom_v1.1/databases/hhpred_dbs/database/pdb.list $work_dir/$name.rank.global $work_dir/$name.rank.global.fil");
...
system("$meta_dir/script/filter_alignments.pl /home/jh7x3/multicom_v1.1/databases/hhpred_dbs/database/pdb.list $fasta_file.global $fasta_file.global.fil");
