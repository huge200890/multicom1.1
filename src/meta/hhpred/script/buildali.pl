...
use lib "/home/jh7x3/multicom_v1.1/src/meta/hhpred/script/";
use Align;
# CUSTOMIZE
#my $dbbase="/home/casp13/MULTICOM_package/casp8/hhpred/nr/nr"; # will use PSI-BLAST dbs $dbbase."90" and $dbbase."70" 
...
my $dbbase ="/home/jh7x3/multicom_v1.1/databases/nr70_90/nr";
my $hh="/home/jh7x3/multicom_v1.1/src/meta/hhpred/script/";
my $perl=$hh;
my $ncbidir="/home/jh7x3/multicom_v1.1/tools/blast-2.2.17/bin"; # directory with ncbi BLAST binaries
my $blastpgp=$ncbidir."/blastpgp -I T -s T"; # blastpgp executable
#our $blastpgp.=" -I T -s T"; # show gi's in defline; use Smith-Waterman

my $execdir="/home/jh7x3/multicom_v1.1/tools/psipred-2.61/bin";  # directory with PSIPRED binaries 
my $datadir="/home/jh7x3/multicom_v1.1/tools/psipred-2.61/data"; # directory with PSIPRED data 
###########################################################################################################
...
Example: buildali.pl test.a3m > ./builddb.log &
\n";
