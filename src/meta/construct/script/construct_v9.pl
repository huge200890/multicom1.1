...
for ($i = 0; $i < $construct_num && $i < @select_temp; $i++)
{
	...
	$hhsearch_dir = "/home/jh7x3/multicom_beta1.0/tools/hhsearch1.2/linux32/";
...
#disable hhblits models here: casp11
if (0)
{
