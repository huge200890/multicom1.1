...
use lib "/home/jh7x3/multicom_v1.1/src/meta/hhsearch1.5/script/";
use Align;
# CUSTOMIZE
...
my $dbbase="/home/jh7x3/multicom_v1.1/databases/nr70_90/nr"; # will use PSI-BLAST dbs $dbbase."90" and $dbbase."70" 
                                   # It is recommended to use nre = nr + env. 
                                   # 90: filtered with CD-HIT to 90% maximum pairwise sequence identity
my $hh="/home/jh7x3/multicom_v1.1/src/meta/hhsearch1.5/script/";
my $perl=$hh;
