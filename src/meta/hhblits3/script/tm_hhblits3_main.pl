...
system("$meta_dir/script/filter_alignments.pl /home/jh7x3/multicom_v1.1/databases/hhblits3_dbs/database/add.list $fasta_file.local $fasta_file.local.fil");
...
system("$meta_dir/script/filter_rank_file.pl /home/jh7x3/multicom_v1.1/databases/hhblits3_dbs/database/add.list $work_dir/$name.rank $work_dir/$name.rank.fil");
