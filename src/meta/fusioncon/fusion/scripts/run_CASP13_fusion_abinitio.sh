...
echo "perl /home/jh7x3/multicom_v1.1/src/meta/fusioncon/fusion/scripts/run_CASP13_fusion_withcontact_LongMediumShortLby5.pl $targetid   $fasta  $dir_output  $contact_file $lbound $ubound $weight"
perl /home/jh7x3/multicom_v1.1/src/meta/fusioncon/fusion/scripts/run_CASP13_fusion_withcontact_LongMediumShortLby5.pl $targetid   $fasta  $dir_output  $contact_file $lbound $ubound $weight
