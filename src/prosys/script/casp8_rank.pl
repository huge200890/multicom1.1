...
system("/home/jh7x3/multicom_v1.1/src/meta/hhsearch/script/tm_hhsearch_main.pl $cm_option $seq_file $out_dir 1>out.log 2>err.log");
...
if (@hhrank < 2)
{
	...
	system("/home/jh7x3/multicom_v1.1/src/meta/hhsearch/script/tm_hhsearch_main.pl $cm_option_nr $seq_file $out_dir");
}
else
{
	$top_temp = $hhrank[1];
...
$cm_sel = `/home/jh7x3/multicom_v1.1/src/prosys/script/evaluate_cm_hh_models.pl /home/jh7x3/multicom_v1.1/src/prosys/ $out_dir $name $out_dir/$name.hh.eva`;
...
if (@models < 5)
{
	...
	system("/home/jh7x3/multicom_v1.1/src/prosys/script/multicom_fr_jury.pl $fr_option $seq_file $out_dir");
}
else
{
	...
	system("/home/jh7x3/multicom_v1.1/src/prosys/script/evaluate_models_nofr.pl /home/jh7x3/multicom_v1.1/src/prosys/ $out_dir $name $out_dir/$name.fr.eva");
	goto CM;
}
...
#	system("/home/casp13/MULTICOM_package/software/prosys/script/pdb2casp.pl $out_dir/$name-$idx.pdb $out_dir/$prefix.pir $idx $out_dir/casp$idx.pdb");
	...
	system("/home/jh7x3/multicom_v1.1/src/prosys/script/pdb2casp.pl $out_dir/$model $out_dir/$prefix.pir $idx $out_dir/casp$idx.pdb");
