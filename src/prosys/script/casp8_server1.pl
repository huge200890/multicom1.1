...
$cm_sel = `/home/jh7x3/multicom_v1.1/src/prosys/script/evaluate_cm_ha_models.pl $out_dir $name $out_dir/$name.cm.eva`;
...
system("/home/jh7x3/multicom_v1.1/src/prosys/evaluate_models.pl /home/jh7x3/multicom_v1.1/src/prosys/ $out_dir $seq_file ./$out_dir/$name.fr.eva");
