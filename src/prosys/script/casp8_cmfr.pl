...
system("/home/jh7x3/multicom_v1.1/src/prosys/script/multicom_cm.pl $cm_option $seq_file $out_dir");
...
$cm_sel = `/home/jh7x3/multicom_v1.1/src/prosys/script/evaluate_cm_hh_models.pl /home/jh7x3/multicom_v1.1/src/prosys/ $out_dir $name $out_dir/$name.cm.eva`;
...
if (! -f "$out_dir/cm.pdb" && ! -f "$out_dir/cm1.pdb" &&  ! -f "$out_dir/cm0.pdb")
{
	...
	system("/home/jh7x3/multicom_v1.1/src/prosys/script/multicom_cm.pl $cm_option_nr $seq_file $out_dir");
} 
else
{
...
if (@models < 5)
{
	...
	system("/home/jh7x3/multicom_v1.1/src/prosys/script/multicom_fr.pl $fr_option $seq_file $out_dir");
}
else
{
	#system("/home/casp13/MULTICOM_package/software/prosys/script/score_models.pl $eva_option $seq_file $out_dir");
	system("/home/jh7x3/multicom_v1.1/src/prosys/script/score_models.pl $eva_option $seq_file $out_dir");
	#system("/home/casp13/MULTICOM_package/software/prosys/script/energy_models_proc.pl $eva_option $seq_file $out_dir");
	system("/home/jh7x3/multicom_v1.1/src/prosys/script/energy_models_proc.pl $eva_option $seq_file $out_dir");
	...
	system("/home/jh7x3/multicom_v1.1/src/prosys/script/evaluate_models_nofr.pl /home/jh7x3/multicom_v1.1/src/prosys/ $out_dir $seq_file $out_dir/$name.fr.eva");
	goto CM;
}
...
system("/home/jh7x3/multicom_v1.1/src/prosys/script/evaluate_models.pl /home/jh7x3/multicom_v1.1/src/prosys/ $out_dir $seq_file $out_dir/$name.fr.eva");
...
for ($i = 0; $i < 5; $i++)
{
	...
	system("/home/jh7x3/multicom_v1.1/tools/scwrl4/Scwrl4 -i $out_dir/$model -o $out_dir/$name-$idx.pdb >/dev/null");
	...
	system("/home/jh7x3/multicom_v1.1/src/prosys/script/pdb2casp.pl $out_dir/$name-$idx.pdb $out_dir/$prefix.pir $idx $out_dir/casp$idx.pdb");
